...
class AppColors {
  ...
  static const resultColor2 = Color(0xFFFFA200);  // 관심
  static final resultColor3 = Colors.purple.shade500; // 주의
  static final resultColor4 = Colors.red.shade500; // 위험
  ...
  static const resultBGColor1 = Color(0xFFD6F9DA); // 음성
  static const resultBGColor2 = Color(0xffffe4c6); // 주의
  static final resultBGColor3 = Colors.purple.shade100; // 위험
  static final resultBGColor4 = Colors.red.shade100; // 심각
  ...
  /// 소변 분석 단계별 Text BG 컬러 값
  static const resultChartColor1 =  Color(0xFF2CCC3F); // 관심
  ...
  static const List<List<Color>> level2GrayColors = [
    [Color(0xFF8C8C8C), Color(0xFFEDEDED),],
    [Color(0xFFEDEDED), Color(0xFF5A779A),],
  ];
  static const List<List<Color>> level2Colors = [
    [Color(0xFFBCEDC3), Color(0xFFEDEDED),],
    [Color(0xFFEDEDED), Color(0xFFF8C096),],
  ];
  // static const List<List<Color>> level2Colors = [
  //   [Color(0xFF8C8C8C), Color(0xFFEDEDED),],
  //   [Color(0xFFEDEDED), Color(0xFF8C8C8C),],
  // ];
  ...
  static const List<List<Color>> level5Colors = [
    ...
    [Color(0xFFEDEDED), Color(0xFFF8C096), Color(0xFFEDEDED),  Color(0xFFEDEDED), Color(0xFFEDEDED),],
    [Color(0xFFEDEDED), Color(0xFFEDEDED), Color(0xFFAA78FD), Color(0xFFEDEDED), Color(0xFFEDEDED),],
    [Color(0xFFEDEDED), Color(0xFFEDEDED), Color(0xFFEDEDED), Color(0xFFFF7080), Color(0xFFEDEDED),],
