import 'package:yocheck_pet/common/theme/color/abs_theme_colors.dart';
...
class DarkAppColors extends AbstractThemeColors {
  ...
  @override
  Color get scaffoldBg => const Color.fromARGB(255, 45, 45, 45);

  @override
  Color get primaryContainer => const Color(0xFF000000);
  ...
  @override
  Color get appBarBackground => const Color.fromARGB(255, 42, 42, 42);
